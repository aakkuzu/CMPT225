...
//         }
    ...
    {
        bool inserted = false;
        inserted = insert( std::move( x ), root );
        return inserted;
  ...
  private:
    ...
    bool insert( const Comparable & x, AvlNode * & t )
    {
        ...
        if( t == nullptr ){
            ...
            inserted = insert( x, t->left );
        }
        else if( t->element < x ){
            inserted = insert( x, t->right );
        }
    ...
    bool insert( Comparable && x, AvlNode * & t )
    {
        ...
        if( t == nullptr ){
            ...
            inserted = insert( std::move( x ), t->left );
        }
        else if( t->element < x ){
            inserted = insert( std::move( x ), t->right );
        }
        balance( t );
        return inserted;
    }
